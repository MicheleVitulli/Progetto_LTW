...
$(document).ready(function(){
    var posizione_scroll = 0;


    $(document).scroll(function() {
        posizione_scroll = $(this).scrollTop();


        if(posizione_scroll < 500) {
            $("body").css('background-color', '#FFFFFF');
        }
        if(posizione_scroll >= 500) {
            $("body").css('background-color', '#F6C6D0');
        }
        if (posizione_scroll >= 1100) {
            $("body").css('background-color', '#FCF69D');
        }
        if (posizione_scroll >= 1900) {
          $("body").css('background-color', '#DBF2FF');
      }
    });
});
